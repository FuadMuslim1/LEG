  ...
  const skills: SkillItem[] = [
    {
      id: 'pronunciation',
      name: 'Pronunciation',
      beforeImg: '/img/skill/before/p_rb.png',
      afterImg: '/img/skill/after/p_rb_3d.png',
      rbImg: '/img/skill/rb/pronunciation_rb.png', // Sesuaikan nama filenya ya Aa
      isAvailable: true,
    },
    {
      id: 'vocabulary',
      name: 'Vocabulary',
      beforeImg: '/img/skill/before/v_rb.png',
      afterImg: '/img/skill/after/v_rb_3d.png',
      rbImg: '/img/skill/rb/vocabulary_rb.png',
      isAvailable: false,
    },
    {
      id: 'grammar',
      name: 'Grammar',
      beforeImg: '/img/skill/before/g_rb.png',
      afterImg: '/img/skill/after/g_rb_3d.png',
      rbImg: '/img/skill/rb/grammar_rb.png',
      isAvailable: false,
    },
    {
      id: 'speaking',
      name: 'Speaking',
      beforeImg: '/img/skill/before/s_rb.png',
      afterImg: '/img/skill/after/s_rb_3d.png',
      rbImg: '/img/skill/rb/speaking_rb.png',
      isAvailable: false,
    },
  ];
