  ...
  const skills: SkillItem[] = [
    {
      id: 'pronunciation',
      name: 'Pronunciation',
      beforeImg: '../public/img/skill/pronunciation_before.png',
      afterImg: '../public/img/skill/pronunciation_after.png',
      rbImg: '../public/img/rb/pronunciation_rb.png', // Sesuaikan nama filenya ya Aa
      isAvailable: true,
    },
    {
      id: 'vocabulary',
      name: 'Vocabulary',
      beforeImg: '../public/img/skill/vocabulary_before.png',
      afterImg: '../public/img/skill/vocabulary_after.png',
      rbImg: '../public/img/rb/vocabulary_rb.png',
      isAvailable: false,
    },
    {
      id: 'grammar',
      name: 'Grammar',
      beforeImg: '../public/img/skill/grammar_before.png',
      afterImg: '../public/img/skill/grammar_after.png',
      rbImg: '../public/img/rb/grammar_rb.png',
      isAvailable: false,
    },
    {
      id: 'speaking',
      name: 'Speaking',
      beforeImg: '../public/img/skill/speaking_before.png',
      afterImg: '../public/img/skill/speaking_after.png',
      rbImg: '../public/img/rb/speaking_rb.png',
      isAvailable: false,
    },
  ];
